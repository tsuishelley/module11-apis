...
all.years <- GET("http://data.unhcr.org/api/stats/time_series_all_years.json?population_type_code=AS&country_of_origin=AFG&country_of_residence=CHE")
all.years.json <- fromJSON(content(all.years, "text"))
print(all.years.json$year)
